...
export default function NotificationBell({
  ...
  return (
    <div className="relative mr-2" data-tour="navbar-notifications">
      ...
      {unreadCount > 0 && (
        <span className="absolute -top-1 -right-1 inline-flex items-center justify-center w-5 h-5 rounded-full text-[10px] font-semibold bg-red-600 text-white pointer-events-none">
