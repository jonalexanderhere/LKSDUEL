  ...
  if (authLoading) {
    return (
      <div className="flex justify-center py-16">
        <Loader fullscreen color="text-amber-500" />
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-transparent">
          ...
          <>
            ...
            {!team ? (
              <div className={`grid grid-cols-1 ${user?.is_admin ? 'md:grid-cols-2' : ''} gap-6`}>
                {user?.is_admin && (
                  <Card className="bg-amber-900/10/5 border-white/10 backdrop-blur-md overflow-hidden animate-slide-up">
                    ...
                    <CardContent className="space-y-4 pt-6">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className="bg-amber-900/10/5 border-white/10 text-white placeholder:text-neutral-500"
                          disabled={busy}
                        />
                      </div>
                      <Button
                ...
                <Card className="bg-amber-900/10/5 border-white/10 backdrop-blur-md overflow-hidden animate-slide-up [animation-delay:100ms]">
                  <CardHeader className="border-b border-white/5">
                    <CardTitle className="text-lg font-semibold text-white flex items-center gap-2">
                  ...
                  <CardContent className="space-y-4 pt-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="bg-amber-900/10/5 border-white/10 text-white placeholder:text-neutral-500 font-mono"
                        disabled={busy}
                      />
                    </div>
                    <Button
      ...
      <ConfirmDialog
        ...
        description={
          confirmExpected ? (
            <div className="space-y-2">
              <p className="text-sm text-amber-100 dark:text-amber-500/70">
                {confirmMessage}
              </p>
              <p className="text-xs text-amber-500/70 dark:text-amber-500/70">
                Type{' '}
                <span className="font-mono text-amber-50 dark:text-gray-100">
                  {confirmExpected}
                </span>{' '}
                to continue.
              </p>
