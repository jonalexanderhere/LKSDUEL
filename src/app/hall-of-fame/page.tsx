  ...
  return (
    <main className="max-w-4xl mx-auto py-8 px-4 mt-10">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 border rounded-xl bg-white dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="space-y-8">
          ...
          {topSolver && (
            <motion.div
              ...
              className="relative overflow-hidden rounded-2xl border border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 via-yellow-500/10 to-transparent p-6 sm:p-8 shadow-[0_0_30px_rgba(234,179,8,0.15)] flex flex-col sm:flex-row items-center gap-6"
            >
              ...
              <div className="relative">
                ...
                <div className="p-1 rounded-full bg-gradient-to-tr from-yellow-500 via-amber-400 to-yellow-600 shadow-[0_0_15px_rgba(234,179,8,0.4)]">
                  <ImageWithFallback
                    ...
                    size={80}
                    className="rounded-full border-2 border-black dark:border-gray-900 bg-white"
                  />
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="relative max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border rounded-lg bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition"
              />
              {searchQuery && (
                <button
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden shadow-sm bg-white dark:bg-gray-800">
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                    ...
                    <AnimatePresence>
                      {filteredSolvers.length === 0 ? (
                        ...
                        filteredSolvers.map((solver, idx) => {
                          ...
                          if (originalRank === 1) {
                            rankDisplay = <span className="text-xl" title="Gold Medal">🥇</span>;
                          } else if (originalRank === 2) {
                            rankDisplay = <span className="text-xl" title="Silver Medal">🥈</span>;
                          } else if (originalRank === 3) {
                            rankDisplay = <span className="text-xl" title="Bronze Medal">🥉</span>;
                          }
                          ...
                          return (
                            <motion.tr
                              ...
                              className="border-b border-gray-100 dark:border-gray-700/60 hover:bg-yellow-500/5 dark:hover:bg-yellow-500/[0.03] transition-colors"
                            >
                              <td className="py-4 px-6 text-center font-bold font-mono text-gray-700 dark:text-gray-300">
                                <div className="flex items-center justify-center h-8 w-8 mx-auto rounded-full bg-gray-100 dark:bg-gray-700/50">
                                  {rankDisplay}
                                </div>
                              </td>
                              ...
                              <td className="py-4 px-6 text-right font-bold text-gray-950 dark:text-white">
                                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-extrabold bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 border border-gray-200 dark:border-gray-600/50">
                                  {solver.count} Solves
                                </span>
                              </td>
                            </motion.tr>
